      ...
      {!isAuthPage && (
        <div className="flex items-center gap-1 sm:gap-2">
          <button
            ...
            className="hidden sm:flex w-8 h-8 rounded-lg items-center justify-center text-[var(--text-secondary)] hover:text-[var(--accent)] hover:bg-[var(--surface-hover)] transition-all border border-[var(--border)] focus:outline-none"
            title="更新数据"
          >
